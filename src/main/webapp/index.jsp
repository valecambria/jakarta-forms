...
%>
<ul class="alert alert-danger col-sm-4 mx-5 px-5 ">
...
<form action="/webapp-form/registro" method="post">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-4" class="col-form-label col-sm-2">
            <select name="pais" id="pais" class="form-select">
                ...
                <option value="VZ" ${param.pais.equals("VZ")? "selected": ""}>VENEZUELA</option>
            </select>
        </div>
            <%
    ...
    <div class="row mb-3">
        ...
        <div class="form-check col-sm-2">
            ...
            ${paramValues.roles.stream().anyMatch(v -> v.equals("ROL_ADMIN")).get()?"checked":""}
            class="form-check-input">
            <label class="form-check-label">Administrador</label>
        </div>
        <div class="form-check col-sm-2">
            <input type="checkbox" name="roles" value="ROL_USER"
             ${paramValues.roles.stream().anyMatch(v -> v.equals("ROL_USER")).get()?"checked":""}
             class="form-check-input">
            <label class="form-check-label">Usuario</label>
        </div>
        <div class="form-check col-sm-2">
            <input type="checkbox" name="roles" value="ROL_MODERADOR"
            ${paramValues.roles.stream().anyMatch(v -> v.equals("ROL_MODERADOR")).get()?"checked":""}
            class="form-check-input">
